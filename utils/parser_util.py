...
def add_data_options(parser):
    ...
    group.add_argument("--dataset", default='grab', choices=['humanml', 'kit', 'humanact12', 'uestc','grab','babel','ntu','humanact12'], type=str,
...
def add_training_options(parser):
    ...
    group.add_argument('--num_samp', type=int, default=50)
    group.add_argument('--iter', type=int, default=0)
    group.add_argument('--mode', default='train')
    group.add_argument('--gpu_index', type=int, default=0)
    group.add_argument('--cfg', default='grab')
    group.add_argument('--test', action='store_true', default=False)

    group.add_argument('--is_other_act', action='store_true', default=False)
    group.add_argument('--is_transi', action='store_true', default=False)
    group.add_argument('--N', type=int, default=10) # number of history and future frames for smoothness
    group.add_argument('--dct_n', type=int, default=5)
    group.add_argument('--t_pre_extra', type=int, default=0) # extra future poses for stopping
...
def add_generate_options(parser):
    ...
    group.add_argument('--cfg', default='grab')
    group.add_argument('--cfg_classifier', default='grab_classifier')
    group.add_argument('--mode', default='test')
    group.add_argument('--test', action='store_true', default=False)
    group.add_argument('--iter', type=int, default=500)
    # default 5
    group.add_argument('--nk', type=int, default=5)
    #group.add_argument('--seed', type=int, default=0)
    group.add_argument('--gpu_index', type=int, default=0)
    group.add_argument('--threshold', type=float, default=0.01)
    group.add_argument('--stop_fn', type=int, default=5)
    group.add_argument('--bs', type=int, default=5)
    group.add_argument('--num_samp', type=int, default=5)
    group.add_argument('--data_type', default='float32')
    group.add_argument('--is_other_act', action='store_true', default=False)
    group.add_argument('--is_transi', action='store_true', default=False)
    group.add_argument('--N', type=int, default=10) # number of history and future frames for smoothness
    group.add_argument('--dct_n', type=int, default=5)
...
def add_evaluation_options(parser):
    ...
    group.add_argument('--num_samp', type=int, default=50)
    group.add_argument('--iter', type=int, default=500)
    group.add_argument('--nk', type=int, default=10)
    #group.add_argument('--seed', type=int, default=0)
    group.add_argument('--mode', default='test')
    group.add_argument('--num_seed', type=int, default=5)
    group.add_argument('--gpu_index', type=int, default=0)
    group.add_argument('--threshold', type=float, default=0.015)
    group.add_argument('--stop_fn', type=int, default=5)
    group.add_argument('--bs', type=int, default=10)
    group.add_argument('--cfg', default='grab')
    group.add_argument('--cfg_classifier', default='grab_classifier')
    group.add_argument('--test', action='store_true', default=False)
    group.add_argument('--is_other_act', action='store_true', default=False)
...
def get_cond_mode(args):
    if args.unconstrained:
        ...
        cond_mode = 'text'
    elif args.dataset in ['grab', 'babel','ntu','humanact12']:
        cond_mode = 'sequence'
    else:
        cond_mode = 'action'
    return cond_mode
